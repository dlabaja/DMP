...
\input{data/balicky_nastaveni}    % Nastavení vzhledu. Soubory v adresáři data neměňte, pokud to není nutné!
...
\begin{document}
	\include{data/titulni_stranka}
        \include{data/zadani}
	\include{data/prohlaseni}	
    %--- Obsah
    \tableofcontents
    \thispagestyle{empty}
    ...
    \include{kap/uvod}
    \include{kap/1_kap/main}	% vkládání kapitol
    \include{kap/2_kap/main}	% vkládání kapitol
    \include{kap/3_kap/main}	% vkládání kapitol
    ...
    \include{data/seznamy} %, seznam obrázků a tabulek - neměnit
    \include{kap/prilohy}
\end{document}
